Shader "Custom/UnityChanSkinURP"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            )
            {
                ...
                float2 offset =
                    normalize(normalVS.xy);

                positionHCS.xy +=
                    offset *
                    _EdgeThickness *
                    INV_EDGE_THICKNESS_DIVISOR *
                    positionHCS.w;
            ...
            ) : SV_Target
            {
                ...
                half3 lerpValues =
                    saturate(
                        (diffuse.rgb - maxChannel)
                        * 255.0
                    );

                half3 outlineColor =
                    lerp(
                        SATURATION_FACTOR * diffuse.rgb,
                        diffuse.rgb,
                        lerpValues
                    );
